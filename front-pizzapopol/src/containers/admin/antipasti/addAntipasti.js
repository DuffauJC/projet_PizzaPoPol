...
import { saveAntipasti } from './../../../api/antipasti'
...
const AddAntipasti = () => {
    ...
    let index = category.findIndex((category) => category.title === "ANTIPASTI")
