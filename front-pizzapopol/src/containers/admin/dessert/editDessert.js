...
import { updateDessert } from '../../../api/dessert'
...
const Editdessert = (props) => {
    ...
    let index = dessert.findIndex(dessert => dessert._id === id)
    ...
    const [state, setState] = useState({
        category: dessert[index].category._id,
        title: dessert[index].title,
        description: dessert[index].description,
        price: dessert[index].price.$numberDecimal,
        error: null,
        redirect: false
    })
